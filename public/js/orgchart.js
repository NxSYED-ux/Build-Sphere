var OrgChart = function(t, e) {
    var r = this;
    if (("string" == typeof t || t instanceof String) && (t = document.querySelector(t)),
    this.element = t,
    ...
    OrgChart._intersectionObserver(this.element, (function(t) {
        r.isVisible = t,
        !1 !== OrgChart.events.publish("visibility-change", [r]) && OrgChart.LAZY_LOADING && r.isVisible && (r._loaded ? r._draw(!1, OrgChart.action.update) : (r._setInitialSizeIfNotSet(),
...
OrgChart.prototype._draw = function(t, e, r, i) {
    ...
    if (!OrgChart.LAZY_LOADING || this.isVisible)
        if (OrgChart.LAZY_LOADING || this._initialized || (this._setInitialSizeIfNotSet(),
            ...
            this.manager.read(t, this.width(), this.height(), n, e, r, (function(t) {
                if (!a.notifierUI.show(t.notif)) {
                    ...
                    for (c = 0; c < t.visibleNodeIds.length; c++) {
                        ...
                        var p = a._get(g.id);
                        OrgChart.RENDER_LINKS_BEFORE_NODES && d.includes(g.id) && (o += a.ui.link(g, a, l, t.bordersByRootIdAndLevel, t.nodes, e)),
                        o += a.ui.node(g, p, t.animations, a.config, void 0, void 0, void 0, e, l, a)
                    }
                    for (c = 0; c < t.visibleNodeIds.length; c++) {
                        g = t.nodes[t.visibleNodeIds[c]];
                        OrgChart.RENDER_LINKS_BEFORE_NODES || (o += a.ui.link(g, a, l, t.bordersByRootIdAndLevel, t.nodes, e)),
                    ...
                    e !== OrgChart.action.exporting) {
                        ...
                        if (a._initialized) {
                            ...
                            a.element.innerHTML = a.ui.css() + y + a.ui.menuButton(a.config),
...
OrgChart.prototype.generateId = function() {
    for (; ; ) {
        ...
        if (null == this.nodes || !this.nodes.hasOwnProperty(t))
            return t
    }
}
,
OrgChart.prototype.moveNodesToVisibleArea = function(t, e) {
    ...
    var c = this.width()
      ...
      , O = 0
      , b = 0;
    if (m - 2 * this.config.padding >= n - l)
        O = (n + l) / 2 - m / 2;
    else
        switch (O = firstRoot.x - m / 2 + OrgChart.manager._getNodeWidth(firstRoot, this.config) / 2,
    ...
    if (C - 2 * this.config.padding >= o - s)
        b = (o + s) / 2 - C / 2;
    else
        switch ((b = -(C / 2 - (o - s) / 2)) > -this.config.padding && (b = -this.config.padding),
        this.config.orientation) {
...
OrgChart.prototype.add = function(t) {
    ...
    this.config.movable && !OrgChart.isNEU(t.pid)) {
        ...
        e && (null != e.movex && (t.movex = e.movex),
...
OrgChart.prototype.replaceIds = function(t, e) {
    this._replaceIds(t),
    this._draw(!1, OrgChart.action.update, void 0, e)
}
,
OrgChart.prototype._replaceIds = function(t) {
    ...
    if (Array.isArray(this.config.roots))
        for (r = 0; r < this.config.roots.length; r++)
            OrgChart.isNEU(t[this.config.roots[r]]) || (this.config.roots[r] = t[this.config.roots[r]]);
    if (this.nodes)
...
OrgChart._addPointLeft = function(t, e, r, i, a) {
    ...
    "bottom" == a ? n = t.rightNeighbor ? t.y + t.h + (t.rightNeighbor.y - (t.y + t.h)) / 2 : t.y + t.h + r.siblingSeparation / 2 : "top" == a && (n = t.leftNeighbor ? t.y + (t.leftNeighbor.y + t.leftNeighbor.h - t.y) / 2 : t.y - r.siblingSeparation / 2),
...
OrgChart.editUI.prototype.show = function(t, e, r) {
    ...
    this.obj.element.querySelector("[data-edit-from-close]").addEventListener("click", (function(e) {
        e.preventDefault(),
        !1 !== OrgChart.events.publish("cancel", [i, {
            id: t
        }]) && i.hide()
    }
    )),
    ...
    this.obj.element.querySelector("[data-edit-from-save]").addEventListener("click", (function(e) {
        ...
        if (!1 !== r) {
            ...
            if (!1 === OrgChart.events.publish("save", [i, o]))
                return;
            i.obj.updateNode(o.data, null, !0),
            i.hide()
        }
    }
    ));
...
OrgChart.editUI.prototype._focusElement = function(t) {
    ...
    e && (e.value && e.value.length && e.setSelectionRange(e.value.length, e.value.length),
    e.focus())
}
,
...
OrgChart.editUI.prototype.content = function(t, e, r, i, a) {
    ...
    OrgChart.isNEU(C) && (C = ""),
    O = OrgChart.isNEU(O) ? OrgChart.icon.user(150, 150, "#8C8C8C", 0, 0) : `<img style="width: 100%;height:100%;border-radius: 50%;object-fit:cover;" src="${O}"></img>`;
    var w = !e
      , k = e ? "display:none;" : ""
      , S = e || !s ? "display:none;" : ""
      , I = m.editFormHeaderColor ? `style="background-color:${m.editFormHeaderColor};"` : ""
      , A = document.createElement("form");
    if (A.setAttribute("data-boc-edit-form", ""),
    ...
    i && (A.style.width = i);
    var L = []
      , E = a ? "" : OrgChart.EDITFORM_CLOSE_BTN;
...
OrgChart.circleMenuUI.prototype._show = function(t, e) {
    ...
    if (!OrgChart.isNEU(a.nodeCircleMenuButton)) {
        ...
        if (OrgChart.isNEU(p) || p.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id) != t) {
            ...
            !1 === f)
                return !1;
            for (var m = 0, C = Object.keys(u.menu).length, O = 2 * a.nodeCircleMenuButton.radius + 4, b = 2 * Math.PI * O, v = b / C - (2 * a.nodeCircleMenuButton.radius + 2); v < 0; )
                O += 8,
                v = (b = 2 * Math.PI * O) / C - (2 * a.nodeCircleMenuButton.radius + 2);
            ...
            u.menu) {
                ...
                A) {
                    var L = parseInt(A.getAttribute("width"))
                      , E = parseInt(A.getAttribute("height"));
                    A.setAttribute("x", -L / 2),
                    A.setAttribute("y", -E / 2)
                }
                var N = m * Math.PI / (C / 2);
                m++;
                var M = Math.cos(N) * O
            ...
            this._linesInterval.push(OrgChart.animate(g[1], {
                x1: -a.nodeCircleMenuButton.radius / 2,
                y1: 0,
                x2: a.nodeCircleMenuButton.radius / 2,
                y2: 0
            ...
            this._linesInterval.push(OrgChart.animate(g[2], {
                x1: -a.nodeCircleMenuButton.radius / 2,
                y1: 6,
                x2: a.nodeCircleMenuButton.radius / 2,
                y2: 6
    ...
    this._draw(!1, OrgChart.action.exporting, i, (function(i, a) {
        ...
        if ("svg" == t.ext)
            if (e)
                ...
                if (d && (s.styles += d.outerHTML),
                s.styles && (n.childNodes[0].insertAdjacentHTML("afterbegin", s.styles),
            ...
            r._pages(t, n.querySelector("svg"), a, (function(i) {
                ...
                if (l && (a.styles += l.outerHTML),
                !1 === o)
                    return !1;
                e || OrgChart.loading.show(r),
                e ? e(r, a, n.querySelector("svg")) : (a = JSON.stringify(a),
                OrgChart._ajax(r.config.exportUrl + "/v3", "POST", a, "arraybuffer", (function(e) {
...
OrgChart.prototype.exportCSV = function(t) {
    ...
    if (!1 === OrgChart.events.publish("exportstart", [this, a]))
        return !1;
    ...
    if (!1 === OrgChart.events.publish("exportend", [this, o]))
        return !1;
...
OrgChart.prototype.exportJSON = function(t) {
    ...
    if (!1 === OrgChart.events.publish("exportend", [this, n]))
        return !1;
...
OrgChart.prototype._pagesA100 = function(t, e, r, i) {
    ...
    if (!OrgChart.EXPORT_PAGES_CUT_NODES && "fit" == t.scale) {
        ...
        for (var b = Object.keys(i.bordersByRootIdAndLevel), v = i.bordersByRootIdAndLevel[b[0]], y = Object.keys(v).length, x = 1; x < b.length; x++)
            y < Object.keys(i.bordersByRootIdAndLevel[b[x]]).length && (v = i.bordersByRootIdAndLevel[b[x]],
        ...
        for (var _ = 0, w = 0; ; ) {
            for (w = _; !(y <= _); ) {
                ...
                if (_ == y - 1 && (k = (v[_].maxY - v[w].minY) / (100 / r)),
                k > c.h)
                    break;
                _++
            }
    ...
    if (!O || OrgChart.EXPORT_PAGES_CUT_NODES || "fit" != t.scale)
        for (e.setAttribute("preserveAspectRatio", "xMinYMin slice"),
        C = []; f < h + l; ) {
            for (; m < d + s; ) {
                var I;
                I = (I = [f, m, p, u]).join(),
...
OrgChart.prototype._defaultExportProfileOptions = function(t, e) {
    return OrgChart.isNEU(t) || null == t.id || null != t.nodeId || (t.nodeId = t.id),
    (OrgChart.isNEU(t) || OrgChart.isNEU(t.nodeId)) && console.error("options.nodeId is not defilned"),
    "svg" == e ? (t.ext = "svg",
    t.mime = "image/svg+xml") : "pdf" == e ? (t.mime = "application/pdf",
    t.ext = "pdf") : "png" == e && (t.mime = "image/png",
    t.ext = "png"),
...
OrgChart.prototype._exportProfile = function(t, e) {
    ...
    if (d)
        for (var c = 0; c < d.children.length; c++)
            "style" == d.children[c].nodeName.toLowerCase() && (s.styles += d.children[c].outerHTML);
    s = JSON.stringify(s),
    ...
    return {
        ...
        remove: function(e, r, i) {
            ...
            if (t[e] && Array.isArray(t[e]) && t[e].length > 0)
                for (var n = t[e].length - 1; n >= 0; n--)
                    (!OrgChart.isNEU(i) && !OrgChart.isNEU(r) && t[e][n].event_id == i && t[e][n].listener == r || !OrgChart.isNEU(i) && OrgChart.isNEU(r) && t[e][n].event_id == i || OrgChart.isNEU(i) && !OrgChart.isNEU(r) && t[e][n].listener == r || OrgChart.isNEU(i) && OrgChart.isNEU(r)) && (t[e].splice(n, 1),
                    a = !0);
            return a
        },
        has: function(e, r) {
        ...
        publish: function(e, r) {
            if (t[e]) {
                ...
                if (i.length > 0) {
                    var o = !0;
                    for (a = 0; a < i.length && (1 == r.length ? o = i[a](r[0]) && o : 2 == r.length ? o = i[a](r[0], r[1]) && o : 3 == r.length ? o = i[a](r[0], r[1], r[2]) && o : 4 == r.length ? o = i[a](r[0], r[1], r[2], r[3]) && o : 5 == r.length && (o = i[a](r[0], r[1], r[2], r[3], r[4]) && o),
                    !1 !== o); a++)
                        ;
                    return o
                }
    ...
    e.onchange = function(e) {
        ...
        i.onload = function() {
            ...
            OrgChart._importSetColumnNames(n, (function(e) {
                ...
                0 != OrgChart.events.publish("import", [t, h]) && (t._putInUndoStack(),
                t.clearRedo(),
...
OrgChart.prototype.importXML = function() {
    ...
    e.onchange = function(e) {
        ...
        i.onload = function() {
            ...
            0 != OrgChart.events.publish("import", [t, r]) && (t._putInUndoStack(),
            t.clearRedo(),
            t.config.nodes = r,
            OrgChart.events.publish("updated", [t]),
            t.filterUI.update(),
...
OrgChart.prototype._resetMovableNodes = function() {
    if (OrgChart.RESET_MOVABLE_ONEXPANDCOLLAPSE && null != this.config.movable) {
        for (var t = !1, e = 0; e < this.config.nodes.length; e++) {
            ...
            null != r.movex && (r.movex = 0,
            t = !0),
            null != r.movey && (r.movey = 0,
            t = !0)
        }
...
OrgChart.prototype.__mouseScrollHandler = function(t, e) {
    if (e.ctrlKey) {
        ...
        if (this.config.mouseScrool == OrgChart.action.ctrlZoom)
            return;
        if (this.config.mouseScrool != OrgChart.action.zoom)
            return
    }
...
OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function(t, e, r) {
    ...
    if (n.draggable) {
        ...
        u.setAttribute("transform", "matrix(1,0,0,1," + (m + O.x) + "," + (C + O.y) + ")"),
        u.style.opacity = .7;
        var b = function(t, e) {
            if (null != t) {
            ...
            if (p) {
                ...
                if (s.left || s.right || s.up || s.down) {
                    ...
                    if (null != d) {
                        ...
                        for (var A = o.getNode(d), L = OrgChart.getStParentNodes(A), E = 0; E < L.length; E++) {
                            var N = o.getNodeElement(L[E].id);
                            N && (N.style.opacity = .1)
                        }
...
OrgChart.prototype._movableHandler = function(t, e, r) {
    var i = this
      ...
      , o = function(t, e) {
        if (Array.isArray(t))
            ...
            e.push(t.id);
            for (r = 0; r < t.stChildren.length; r++)
                o(t.stChildren[r], e);
    ...
    for (var h = this.getSvg(), d = OrgChart._getClientXY(e), c = [], g = [], p = [], u = [], f = [], m = [], C = [], O = [], b = 0; b < n.length; b++) {
        ...
        if (y) {
            ...
            if (_) {
                ...
                C.push(null),
                O.push(null);
            if (this.config.movable == OrgChart.movable.node)
                break
        }
    }
    t._dragEventFired = !1;
            ...
            if (d.left || d.right || d.up || d.down) {
                ...
                i.moveStart(d, (function(t) {
                    for (var e = 0; e < g.length; e++) {
                        ...
                        if (c[e].parent)
                            for (s = OrgChart.ui.link(c[e].parent, i, A, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0),
                            h = 0; h < s.length; h++) {
                                var p;
                                d = s[h];
                                (p = i.element.querySelector(`[data-l-id="[${d.id}][${d.childId}]"]`)) && (p.innerHTML = d.html)
                            }
                        f[e].setAttribute("transform", "matrix(" + g[e].toString() + ")"),
                        m[e] && m[e].setAttribute("transform", "matrix(" + C[e].toString() + ")")
                    }
                }
                ))
            } else {
                ...
                if (null != k) {
                    ...
                    !i.canUpdateLink(c[0].id, k) && h.classList ? (h.classList.remove("boc-cursor-grab"),
                    h.classList.remove("boc-cursor-move"),
                    h.classList.remove("boc-cursor-copy"),
                ...
                if (s.parent)
                    if (i.config.movable == OrgChart.movable.detachTree)
                        (Y = i.element.querySelector(`[data-l-id="[${s.parent.id}][${s.id}]"]`)) && Y.parentElement.removeChild(Y);
                    else
                        for (z = OrgChart.ui.link(s.parent, i, A, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0),
                        P = 0; P < z.length; P++) {
                            var Y;
                            j = z[P];
                            (Y = i.element.querySelector(`[data-l-id="[${j.id}][${j.childId}]"]`)) && (Y.innerHTML = j.html)
                ...
                if (!t._dragEventFired && (Math.abs(r.x - I.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - I.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)) {
                    if (!1 === OrgChart.events.publish("drag", [i, a, e, n]) && N(),
                    i.config.enableDragDrop)
                ...
                for (_ = 0; _ < g.length; _++)
                    ...
                    m[_] && m[_].setAttribute("transform", "matrix(" + C[_].toString() + ")")
            }
        }
    }
      , N = function(e) {
        ...
        h.classList.remove("boc-cursor-nodrop"),
        h.classList.remove("boc-cursor-copy")),
        h.removeEventListener(r.move, E),
        h.removeEventListener(r.up, N),
        r.leave && h.removeEventListener(r.leave, N),
        c[0].id != k && null != k) {
            var n = i.getNode(k);
            if (!1 === (o = OrgChart.events.publish("drop", [i, c[0].id, n.id, f[0], e])))
                return L(k, S),
                void (i._gragStartedId = null);
                ...
                if (i.config.movable && !1 !== o)
                    if (i.config.movable == OrgChart.movable.detachTree) {
                        ...
                        for (a = 0; a < g.length; a++) {
                            var C;
                            (C = i.get(g[a])) && (null != C.movex ? C.movex += u : C.movex = u,
                            null != C.movey ? C.movey += m : C.movey = m,
                            i.update(C))
                        }
                        OrgChart.events.publish("updated", [i]),
                        i.draw(OrgChart.action.update, {
                            dragNodeIdList: g
                        })
                    }
            }
    ...
    h.addEventListener(r.move, E),
    h.addEventListener(r.up, N),
    r.leave && h.addEventListener(r.leave, N)
}
,
OrgChart.prototype._dragDropHandler = function(t, e, r) {
    ...
    var m = function(t, e) {
        ...
        if (d) {
            ...
            if (C.left || C.right || C.up || C.down) {
                ...
                null != o) {
                    ...
                    !s.canUpdateLink(n.id, o) && h.classList ? (h.classList.remove("boc-cursor-grab"),
                    h.classList.remove("boc-cursor-move"),
                    h.classList.remove("boc-cursor-copy"),
                    h.classList.add("boc-cursor-nodrop")) : h.classList && (h.classList.remove("boc-cursor-grab"),
                    h.classList.remove("boc-cursor-move"),
                ...
                if (c[4] = g + E,
                c[5] = p + N,
                !t._dragEventFired && (Math.abs(r.x - d.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - d.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE))
      ...
      , O = function(e) {
        ...
        n.id == o || null == o)
            return t._dragEventFired && OrgChart.events.publish("drop", [s, n.id, void 0, f, e]),
            h.removeChild(f),
    ...
    if (t) {
        if (!this._moveInterval) {
            ...
            this._moveInterval = setInterval((function() {
                ...
                d.xWithoutScale = l * OrgChart.MOVE_STEP) : t.right && (l++,
                d.x = -l * OrgChart.MOVE_STEP / o,
                d.xWithoutScale = -l * OrgChart.MOVE_STEP),
                t.up ? (s++,
                d.y = s * OrgChart.MOVE_STEP / o,
                d.yWithoutScale = s * OrgChart.MOVE_STEP) : t.down && (s++,
                d.y = -s * OrgChart.MOVE_STEP / o,
...
OrgChart.prototype._mouseDownHandler = function(t, e, r) {
    ...
    "pan" == s.type && (this._hideBeforeAnimation(),
    this._changeCursorOnPanStart(a, n, e));
    var h = function(t) {
    ...
    this.config.enablePan && (t.addEventListener(r.move, h),
...
OrgChart.searchUI.prototype._initSearchFields = function() {
    if (null == this.instance.config.searchFields) {
        ...
        this._searchFields = this.instance.config.searchFields;
    if (null == this.instance.config.searchFieldsAbbreviation) {
        this.searchFieldsAbbreviation = {};
        for (t = 0; t < this._searchFields.length; t++) {
            for (var r = this._searchFields[t], i = 0, a = r.slice(0, i + 1).toLowerCase(); this.searchFieldsAbbreviation[a]; )
                i++,
                a = r.slice(0, i + 1).toLowerCase();
            this.searchFieldsAbbreviation[a] = r
        }
    } else
        this.searchFieldsAbbreviation = this.instance.config.searchFieldsAbbreviation;
...
OrgChart.searchUI.prototype._search = function() {
    var t, e = this;
    if (this._searchAfterEnterPress = !1,
    this.input.value == OrgChart.SEARCH_HELP_SYMBOL)
        ...
        t = `<table border="0" cellspacing="0" cellpadding="0">\n                        <tbody>\n                            ${function() {
            for (var t = "", i = 0; i < e.lastSearch.length && !(i >= OrgChart.SEARCH_RESULT_LIMIT); i++) {
                ...
                var l = ""
                  , s = "";
                e.instance.config.searchDisplayField == a.__searchField ? l = a.__searchMarks : e.instance.config.searchDisplayField ? (l = a[e.instance.config.searchDisplayField],
                OrgChart.isNEU(l) && (l = ""),
                s = a.__searchMarks) : l = a.__searchMarks;
                var h = {
                    img: n,
                    nodeId: a.id,
                    first: l,
                ...
                OrgChart.events.publish("add-item", [e, h]),
                t += h.html
            }
            return t
        }()}  \n                        </tbody>\n                    </table>`
...
OrgChart.searchUI.prototype.hide = function() {
    if (!1 === OrgChart.events.publish("hide", [this]))
        return !1;
    this._searchAfterEnterPress && (this._searchAfterEnterPress = !1,
    this.instance.draw()),
    this.lastSearch = [],
...
OrgChart.manager.prototype.read = function(t, e, r, i, a, n, o, l) {
    ...
    OrgChart.state._get(this.config.state, e, r, (function(h) {
        ...
        if (t) {
            ...
            a != OrgChart.action.exporting && (s.maxX = d,
            s.maxY = c,
            s.minX = g,
            s.minY = p,
            s.roots = f,
...
OrgChart.manager.prototype._read = function(t, e) {
    ...
    o._setPositions(n, r.layoutConfigs, (function(e) {
        ...
        r.action == OrgChart.action.exporting ? o = r._fixAdjustForExport : r._fixAdjustForExport = o;
        for (var l = {
            minX: null,
            minY: null,
            maxX: null,
            maxY: null
        }, s = {}, h = [], d = 0; d < n.length; d++)
            OrgChart.manager._setMinMaxXYAdjustifyIterate(n[d], n[d], l, 0, s, o, r.config.orientation, h);
        for (var c in h)
            for (var g in h[c]) {
                var p = s[c][g]
                  , u = h[c][g];
...
OrgChart.manager._initNode = function(t, e, r, i, a, n, o) {
    ...
    for (var p = 0; p < t.childrenIds.length; p++) {
        ...
        if (OrgChart.manager._setCollpasedProperty(u, g, d, a, h, i, c),
        !u.collapsed) {
            if (u.parent = t,
            null != u.ppid) {
                var f = e[u.ppid];
            ...
            (-1 != u.tags.indexOf("left-partner") || -1 != u.tags.indexOf("right-partner") || -1 != u.tags.indexOf("partner") || u.parentPartner) && -1 == n.indexOf(t.id) && n.push(t.id),
            t.children.push(u)
        }
    }
    if (h != OrgChart.action.minimize || t.min ? h == OrgChart.action.maximize && !0 === t.min ? (d.all || d.id == t.id) && (t.min = !1) : h == OrgChart.action.exporting && !1 === d.min ? t.min = !1 : h == OrgChart.action.init && null != c && (t.min = c.min.has(t.id)) : (d.all || d.id == t.id) && (t.min = !0),
    !t.min)
        for (p = 0; p < t.stChildrenIds.length; p++) {
            u = e[t.stChildrenIds[p]];
            t.tags && t.tags.has("filter") || (u.stParent = t,
            t.stChildren.push(u))
        }
    null != i && (t.level = i),
    r && (t.lcn = r);
...
OrgChart.manager._iterate = function(t, e, r, i, a, n, o, l, s, h, d, c) {
    ...
    if (OrgChart.manager._initNode(e, r, s, i, h, d, c),
    ...
    OrgChart.MIXED_LAYOUT_FOR_NODES_WITH_COLLAPSED_CHILDREN && !e.isAssistant && e.parent) {
        ...
        u = 0,
        f = 0,
        m = 0; m < e.parent.children.length; m++) {
            var C;
    ...
    for (var O = 0; O < e.stChildren.length; O++) {
        ...
        OrgChart.manager._iterate(t, e.stChildren[O], r, 0, a, n, o, l, b, h, d, c)
    }
    i++;
...
OrgChart.manager.__createNodes = function(t, e, r, i, a, n, o, l) {
    ...
    for (d = 0; d < s.length; d++) {
        ...
        O) {
            var v = n ? n[O.id] : null;
            v && (O.min = v.min),
            O.stChildrenIds.push(f.id)
        } else
            b ? (C && (f.collapsed = C.collapsed,
            f.min = C.min),
            b.childrenIds.push(f.id)) : (C && (f.collapsed = C.collapsed,
            f.min = C.min),
            e.push(f),
            o.push(f.id));
...
OrgChart.manager._createNodes = function(t) {
    var e = t.manager.config
      ...
      , s = []
      , h = [];
    if (OrgChart.manager.__createNodes(l, s, e, i, a, n, h, t),
    null != e.roots) {
        s = [];
            ...
            if (c) {
                ...
                if (!u) {
                    if (!OrgChart.isNEU(c.pid))
                        (ft = (O = l[c.pid]).childrenIds.indexOf(c.id)) > -1 && O.childrenIds.splice(ft, 1);
                    s.push(c)
                }
            }
        }
    ...
    i == OrgChart.action.exporting && null != a.id && ((C = l[a.id]) && (C.pid = null,
    s = [C]));
    var m = [];
    if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
        for (d = 0; d < e.expand.nodes.length; d++) {
            var C = l[e.expand.nodes[d]];
            for (!0 === e.expand.allChildren && OrgChart.manager._addExpandedNodeIdsIterate(C, l, m); C; )
                m.push(C.id),
                null == C.pid && null != C.stpid ? (C = l[C.stpid]).min = !1 : C = l[C.pid]
        }
    ...
    if (i == OrgChart.action.collapse && a && Array.isArray(a.expandIds) && Array.isArray(a.collapseIds))
        for (d = 0; d < a.ids.length; d++) {
            if (a.expandIds.has(a.collapseIds[d]))
                console.error(`id ${a.collapseIds[d]} exist in both collapseIds and expandIds`);
            else
                (C = l[a.collapseIds[d]]) && (C.collapsed = !0)
        }
    for (d = s.length - 1; d >= 0; d--)
        s[d].collapsed && s.splice(d, 1);
    for (d = 0; d < S.length; d++) {
        C = l[S[d]];
        var I = []
          , A = []
        ...
        for (v = 0; v < C.children.length; v++) {
            (H = C.children[v]).isAssistant ? I.push(H.id) : -1 != H.tags.indexOf("right-partner") ? (H.isPartner = 1,
            H.children = [],
            A.push(H.id)) : -1 != H.tags.indexOf("left-partner") ? (H.isPartner = 2,
            H.children = [],
            L.push(H.id)) : -1 == H.tags.indexOf("partner") || N % 2 ? -1 != H.tags.indexOf("partner") && N % 2 ? (H.isPartner = 2,
            H.children = [],
            L.push(H.id),
            N++) : H.parentPartner ? (E[H.parentPartner.id] || (E[H.parentPartner.id] = []),
            E[H.parentPartner.id].push(H.id)) : I.push(H.id) : (H.isPartner = 1,
            H.children = [],
            A.push(H.id),
            N++)
        }
        ...
        for (v = 0; v < A.length; v++) {
            E[(H = l[A[v]]).id] ? C.children.push(H) : C.children.splice(0, 0, H);
            for (var P = 0; P < H.childrenIds.length; P++)
                R.push(H.childrenIds[P])
        }
        var F = [];
        for (v = 0; v < L.length; v++) {
            E[(H = l[L[v]]).id] ? C.children.push(H) : C.children.splice(0, 0, H);
            for (P = 0; P < H.childrenIds.length; P++)
                F.push(H.childrenIds[P])
        }
        for (v = 0; v < F.length; v++) {
            (H = l[F[v]]).collapsed || (H.parentPartner = H.parent,
            H.parent = C,
        ...
        for (v = L.length - 1; v >= 0; v--)
            if (E[L[v]])
                for (f = 0; f < E[L[v]].length; f++)
                    C.children.push(l[E[L[v]][f]]),
                    M++,
        ...
        for (v = 0; v < A.length; v++)
            if (E[A[v]])
                for (f = 0; f < E[A[v]].length; f++)
                    C.children.push(l[E[A[v]][f]]),
                    T++,
                    -1 == B.indexOf(A[v]) && B.push(A[v]);
        for (v = 0; v < R.length; v++) {
            (H = l[R[v]]).collapsed || (H.parentPartner = H.parent,
            H.parent = C,
            H.isChildOfPartner = !0,
            C.children.push(H))
        }
        C.partnerSeparation = Math.max(U.length, B.length) * e.partnerChildrenSplitSeparation + e.minPartnerSeparation,
        I.length || !M || T ? I.length || M || !T ? I.length || 1 != M || 1 != T ? I.length || M || T ? !I.length || M || T ? I.length && (M || T) ? C.hasPartners = 7 : C.hasPartners = 1 : C.hasPartners = 6 : C.hasPartners = 5 : C.hasPartners = 4 : C.hasPartners = 3 : C.hasPartners = 2
    }
    for (d = 0; d < w.length; d++) {
        var D = r[(C = l[w[d]]).lcn ? C.lcn : "base"];
        for (v = 0; v < C.subLevels; v++) {
            var z = new OrgChart.node(C.id + "_sub_level_index_" + v,C.pid,[],"subLevel");
            if (OrgChart.manager._initDinamicNode(z, C.lcn),
            O = C.parent)
                (ft = O.children.indexOf(C)) > -1 && (O.children.splice(ft, 1),
                O.children.splice(ft, 0, z)),
                z.children.push(C),
                z.parent = O,
                C.parent = z,
                l[z.id] = z
    ...
    for (var j in _) {
        ...
        OrgChart.manager._initDinamicNode(z, O.lcn, !0),
        l[z.id] = z;
        var Y = [];
        for (v = O.children.length - 1; v >= 0; v--) {
            (H = O.children[v]).isAssistant ? (H.parent = null,
            O.children.splice(v, 1),
            Y.splice(0, 0, H.id)) : H.isPartner || (H.parent && k[H.parent.id] && z && H.parent.id != z.id && (Object.defineProperty(k, z.id, Object.getOwnPropertyDescriptor(k, H.parent.id)),
        ...
        if (Y.length % 2) {
            var q = l[Y[Y.length - 1]]
              , X = new OrgChart.node(q.id + "_mirror",O.pid,[],"mirror");
            OrgChart.manager._initDinamicNode(X, q.lcn, !0),
            X.isAssistant = !0,
            X.w = q.w,
            X.h = q.h,
            l[X.id] = X,
        ...
        if (w.length) {
            ...
            if (rt) {
                ...
                for (var j in k) {
                    ...
                    for (d = 0; d < it.length; d++) {
                        var ht = it[d];
                        (null === st || w.has(ht)) && (st = l[ht].parent.id,
                        lt || OrgChart.isNEU(l[ht].subLevels) || (lt = l[ht].subLevels > 0)),
                        at[st] || (at[st] = []),
                        at[st].push(ht),
                        lt && (ot[st] = j,
                        nt[st] || (nt[st] = []),
                ...
                for (var j in at)
                    at[j].length > OrgChart.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN && (k[j] = at[j])
            }
        }
        for (var j in k) {
            for (var ct = O = l[j]; ct.isSplit; )
                ct = l[ct.pid];
            for (; ct.isSubLevel; )
                ct = l[ct.pid];
            if (0 != (D = r[O.lcn ? O.lcn : "base"]).layout || tt) {
                ...
                et.layouts.length || et.layouts.push({
                    layout: et.layout,
                ...
                for (var gt = 0; gt < et.layouts.length; gt++) {
                    ...
                    if (pt.layout == OrgChart.layout.grid && pt.childrenIds.length > 2) {
                        ...
                        for (d = 0; d < pt.childrenIds.length; d += Ct) {
                            ...
                            for (v = 0; v < Ct; v++) {
                                ...
                                if (pt.childrenIds.length - 1 < d + v)
                                    break;
                                (H = l[ht = pt.childrenIds[d + v]]).parent = l[mt],
                                l[mt].children.push(H),
                                bt || (Ct / 2 - 1 == v && (Ot = new OrgChart.node(pt.childrenIds[d + v - 1] + "_grid_pseudo_node_" + pt.childrenIds[d + v + 1],mt,[],"subLevel"),
                    ...
                    if (pt.layout == OrgChart.layout.mixed) {
                        ...
                        for (d = pt.childrenIds.length - 1; d >= 0; d--) {
                            for (H = l[pt.childrenIds[d]],
                            v = 0; v < O.children.length; v++)
...
OrgChart.manager.getAllFields = function(t) {
    ...
    for (r = 0; r < t.nodes.length; r++)
        for (var i in t.nodes[r])
            i !== OrgChart.ID && i !== OrgChart.TAGS && i !== OrgChart.NODES && i !== OrgChart.PID && i !== OrgChart.STPID && "movex" !== i && "movey" !== i && (t.nodeBinding[i] || e.has(i) || e.push(i));
    return e
}
,
...
OrgChart.manager._getResponse = function(t, e, r, i, a, n, o, l, s, h, d, c, g, p, u) {
    ...
    0 == h.length || null == s && !u && i.align == OrgChart.CENTER) {
        ...
        if (x - 2 * i.padding >= a - o)
            ...
            switch (w = f.x - x / 2 + OrgChart.manager._getNodeWidth(f, i) / 2,
            i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
...
OrgChart.manager._iterate2 = function(t, e, r, i, a, n, o, l, s, h) {
    if (OrgChart.manager._isVisible(t, r, i, a)) {
        ...
        if ((a == OrgChart.action.expand || a == OrgChart.action.collapse || a == OrgChart.action.maximize) && l && l[t.id] && "expandCollapseToLevel" == n.method) {
            ...
            if (f = e[n.id]) {
                for (c = t.parent; null != c && -1 == n.ids.indexOf(t.id) && -1 == n.ids.indexOf(c.id); )
                    c = c.parent;
                c && (d = {
                    x: f.x + f.w / 2 - t.w / 2,
                    y: f.y + f.h / 2 - t.h / 2
        ...
        if (null != d && null != d.x && null != d.y)
            if (d.x != t.x || d.y != t.y)
                n && n.dragNodeIdList && -1 != n.dragNodeIdList.indexOf(t.id) || (h[0].push(t.id),
                h[1].push({
...
OrgChart.manager._setMinMaxXYAdjustifyIterate = function(t, e, r, i, a, n, o, l) {
    t.x += n.x,
    t.y += n.y;
    for (var s = 0; s < t.stChildren.length; s++)
        OrgChart.manager._setMinMaxXYAdjustifyIterate(t.stChildren[s], t.stChildren[s], r, 0, a, n, o, l);
    ...
    t.layout ? (null == l[e.id] && (l[e.id] = {}),
    null == l[e.id][t.sl] && (l[e.id][t.sl] = t)) : OrgChart._setMinMaxXY(t, a[e.id][t.sl]),
    null != t.movex && (t.x += t.movex),
    null != t.movey && (t.y += t.movey),
    OrgChart._setMinMaxXY(t, r),
    i++;
    for (s = 0; s < t.children.length; s++)
        OrgChart.manager._setMinMaxXYAdjustifyIterate(t.children[s], e, r, i, a, n, o, l)
}
,
...
OrgChart.manager._verticalAssistantIterate = function(t, e) {
    ...
    if (t.isAssistant && t.isSplit && t.children.length) {
        for (var i = t.parent.children[0], a = t.parent.children[2], n = t.parent; !n.hasAssistants; )
            n = n.parent;
        var o = {
            max: 0
        }
...
OrgChart._addDottedLines = function(t) {
    var e = t.nodes;
    if ((t.groupDottedLines.length || t.dottedLines.length) && (e = JSON.parse(JSON.stringify(e))),
    t.groupDottedLines.length)
        for (var r = [], i = 0; i < t.groupDottedLines.length; i++) {
            ...
            for (o = 0; o < e.length; o++)
                if (e[o].id == a.from) {
                    if ((d = JSON.parse(JSON.stringify(e[o]))).id = `balkan_group_dotted_${a.rootId}_balkan_id_${e[o].id}`,
    ...
    if (t.dottedLines.length)
        for (i = 0; i < t.dottedLines.length; i++) {
            ...
            for (o = 0; o < e.length; o++)
                if (e[o].id == h.from) {
                    var d;
                    if ((d = JSON.parse(JSON.stringify(e[o]))).id = `balkan_dotted_${h.rootId}_balkan_id_${e[o].id}`,
                    h.rootId == h.to ? d.pid = h.to : d.pid = `balkan_dotted_${h.rootId}_balkan_id_${h.to}`,
                    d.tags || (d.tags = []),
                    d.tags.push("boc-dotted-connector"),
                    h.tags)
                        for (s = 0; s < h.tags.length; s++)
                            d.tags.push(h.tags[s]);
                    e.push(d);
                    break
                }
        }
...
OrgChart.ui = {
    ...
    node: function(t, e, r, i, a, n, o, l, s, h) {
        ...
        d.defs && (c = c.replaceAll("{randId}", OrgChart.ui._defsIds[t.templateName])),
        ...
        for (var p in o) {
            ...
            g.name = f,
            g.field = p,
            !1 !== OrgChart.events.publish("field", [h, g]) && null != g.value && null != g.value && null != g.element && (!m || m && !OrgChart.isNEU(g.value))) {
                if (!m && "string" == typeof g.value) {
                    var C = g.element;
                    C && (C = C.replaceAll("{ew}", t.w - (t.padding ? t.padding[1] : 0)).replaceAll("{cw}", t.w / 2)),
    ...
    nodeBtns: function(t, e, r, i, a) {
        var n = "";
        return null == t.nodeMenu || e.isSplit || r === OrgChart.action.exporting || (n += i.nodeMenuButton.replace("{id}", e.id).replace("{cw}", e.w / 2).replace("{ch}", e.h / 2).replace("{ew}", e.w - (e.padding ? e.padding[1] : 0)).replace("{eh}", e.h - (e.padding ? e.padding[2] : 0))),
    ...
    expandCollapseBtn: function(t, e, r, i, a) {
        ...
        return OrgChart.events.publish("renderbuttons", [t, C]),
        C.html
    },
    link: function(t, e, r, i, a, n, o) {
        ...
        if (t.hasPartners) {
            ...
            for (var C = 0; C < t.children.length; C++) {
                (b = t.children[C]).parentPartner ? (m.ppnodes[b.id] = b.parentPartner,
                m.ids.push(b.id),
                1 == b.parentPartner.isPartner ? (-1 == m.rightIds.indexOf(b.parentPartner.id) && m.rightIds.push(b.parentPartner.id),
                m.indexes[b.id] = m.rightIds.indexOf(b.parentPartner.id),
                m.firstRight || (m.firstRight = b)) : 2 == b.parentPartner.isPartner && (-1 == m.leftIds.indexOf(b.parentPartner.id) && m.leftIds.push(b.parentPartner.id),
                m.indexes[b.id] = m.leftIds.indexOf(b.parentPartner.id),
                m.lastLeft = b)) : b.isPartner || (m.lastLeft = b,
        ...
        for (C = 0; C < t.children.length; C++) {
            var O, b = t.children[C], v = i[u][b.sl], y = {
                xa: 0,
                ya: 0,
                xb: 0,
                yb: 0,
            ...
            if (b.isChildOfPartner)
                ...
                else if ((k || b.layout > 1) && b.leftNeighbor && b.leftNeighbor.isSplit)
                    switch (s.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                    case OrgChart.orientation.bottom:
            ...
            if (S)
                O = S,
                x = x.replaceAll("{rounded}", S).replaceAll("{edge}", S).replaceAll("{curve}", O);
            else if (-1 != x.indexOf("{rounded}"))
                if (y.xa == y.xb && y.xa == y.xc && y.xa == y.xd || y.ya == y.yb && y.ya == y.yc && y.ya == y.yd)
                    ...
                    O = "M" + I.x1 + "," + I.y1 + " " + I.x2 + "," + I.y2 + " Q" + I.qx1 + "," + I.qy1 + " " + I.qx2 + "," + I.qy2 + " L" + A.x2 + "," + A.y2 + " Q" + A.qx1 + "," + A.qy1 + " " + A.qx2 + "," + A.qy2 + " L" + A.x3 + "," + A.y3,
                    x = x.replaceAll("{rounded}", O)
                }
            else
                -1 != x.indexOf("{edge}") ? (O = "M" + y.xa + "," + y.ya + " " + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " L" + y.xd + "," + y.yd,
                x = x.replaceAll("{edge}", O)) : -1 != x.indexOf("{curve}") ? (O = "M" + y.xa + "," + y.ya + " C" + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " " + y.xd + "," + y.yd,
                x = x.replaceAll("{curve}", O)) : (O = x.replaceAll("{xa}", y.xa).replaceAll("{ya}", y.ya).replaceAll("{xb}", y.xb).replaceAll("{yb}", y.yb).replaceAll("{xc}", y.xc).replaceAll("{yc}", y.yc).replaceAll("{xd}", y.xd).replaceAll("{yd}", y.yd),
                x = O);
            ...
            var E = "";
            for (var N in e.config.linkBinding) {
                var M = e.config.linkBinding[N]
                  , T = e._get(b.id);
                if (T) {
                    var B = T[M];
                    L.value = B,
                    L.element = h[N],
                    L.name = M,
                    !1 !== OrgChart.events.publish("label", [e, L]) && (OrgChart.isNEU(L.value) || OrgChart.isNEU(L.element) || (E += L.element.replace("{val}", L.value)))
                }
            }
            if ("" != E) {
                var U = y.x
                ...
                E = OrgChart.linkFieldsOpenTag.replace("{x}", U).replace("{y}", R).replace("{rotate}", 0) + E + OrgChart.grCloseTag,
                d.push(E)
            }
...
OrgChart._moveToBoundaryArea = function(t, e, r, i) {
    ...
    e[0] !== a[0] || e[1] !== a[1] ? OrgChart.animate(t, {
        viewBox: e
    }, {
        viewBox: a
...
OrgChart.wrapText = function(t, e) {
    ...
    if (OrgChart.ESCAPE_HTML && "string" == typeof str && OrgChart._isHTML(t))
        return OrgChart._escapeHtml(t);
    if (!OrgChart.ESCAPE_HTML && OrgChart._isHTML(t))
        return t;
    ...
    c || (c = "ellipsis");
    var u = c.split("-");
    if (u.length > 1 && (a = parseInt(c.split("-")[1]),
    ...
    if (-1 != c.indexOf("multiline")) {
        ...
        for (var y = 1, x = !1, _ = 1; _ < C.length; _++) {
            ...
            if (b.firstChild.data += " " + C[_],
            b.getComputedTextLength() > d) {
                if (b.firstChild.data = b.firstChild.data.slice(0, w),
                y++,
                a && y > a) {
                    if (n && p.children.length == a) {
                        var k = p.children[a - 1].textContent;
                        p.children[a - 1].textContent = k.substring(0, k.length - 3) + "...",
                        x = !0
                    }
                    break
                }
...
OrgChart.childrenTotalCount = function(t, e) {
    for (var r = 0, i = 0; i < e.childrenIds.length; i++) {
        ...
        a && (r++,
        r += OrgChart.childrenTotalCount(t, a))
    }
    return r
}
,
...
OrgChart.gradientCircleForDefs = function(t, e, r, i) {
    ...
    return Array.isArray(e) || (e = [e, e, e, e, e, e]),
...
OrgChart._intersectionObserver = function(t, e) {
    "function" == typeof IntersectionObserver ? new IntersectionObserver((function(t, r) {
        t.forEach((function(t) {
            ...
            0 == t.intersectionRatio && (r = t.isIntersecting),
            e(r)
        }
        ))
    }
...
OrgChart.roundPathCorners = function(t, e, r) {
    ...
    if (t.length > 1) {
        var s = o(t[0])
          , h = null;
        "Z" == t[t.length - 1][0] && t[0].length > 2 && (h = ["L", s.x, s.y],
        t[t.length - 1] = h),
        l.push(t[0]);
        for (var d = 1; d < t.length; d++) {
            ...
            if (p && c && c.length > 2 && "L" == g[0] && p.length > 2 && "L" == p[0]) {
                var u, f, m = o(c), C = o(g), O = o(p);
                r ? (u = a(C, c.origPoint || m, e),
                f = a(C, p.origPoint || O, e)) : (u = i(C, m, e),
                f = i(C, O, e)),
                n(g, u),
                g.origPoint = C,
                l.push(g);
    ...
    if ((this.config.mouseScrool == OrgChart.action.xScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
        ...
        !function(t, i, a) {
            ...
            function o() {
                ...
                Math.ceil(e.bar.scrollLeft) == Math.ceil(e.position) ? n = !1 : (e.bar.scrollLeft += t,
                l(o))
            }
            t.addEventListener("wheel", (function(t) {
                ...
                if (e.config.mouseScrool == OrgChart.action.xScroll)
                    (a = t.deltaX || t.wheelDeltaX) || (a = t.deltaY || t.wheelDeltaY);
                else if (e.config.mouseScrool == OrgChart.action.scroll && !(a = r || !t.shiftKey ? t.deltaX || t.wheelDeltaX : t.deltaY || t.wheelDeltaY))
                    return;
                a = -a,
...
OrgChart.xScrollUI.prototype.setPosition = function() {
    if (this.bar) {
        ...
        OrgChart.events.publish("change", [this, {
    ...
    if ((this.config.mouseScrool == OrgChart.action.yScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
        ...
        !function(t, i, a) {
            ...
            function o() {
                ...
                Math.ceil(e.bar.scrollTop) == Math.ceil(e.position) ? n = !1 : (e.bar.scrollTop += t,
                l(o))
            }
            t.addEventListener("wheel", (function(t) {
                if (t.ctrlKey)
                ...
                if (e.config.mouseScrool == OrgChart.action.yScroll)
                    (a = t.deltaY || t.wheelDeltaY) || (a = t.deltaX || t.wheelDeltaX);
                else if (e.config.mouseScrool == OrgChart.action.scroll && !(a = r || !t.shiftKey ? t.deltaY || t.wheelDeltaY : t.deltaX || t.wheelDeltaX))
                    return;
                a = -a,
                a = Math.max(-1, Math.min(1, a)),
                e.position += -a * i;
...
OrgChart.pdfPrevUI.show = function(t, e) {
    ...
    var a, n, o, l = t.element.querySelector("#boc-ppdf-size"), s = t.element.querySelector("#boc-ppdf-layout"), h = t.element.querySelector("#boc-ppdf-scale"), d = t.element.querySelector("#boc-ppdf-margin"), c = t.element.querySelector("#boc-ppdf-header"), g = t.element.querySelector("#boc-ppdf-footer");
    l.value = e.format,
    s.value = e.landscape,
    h.value = e.scale,
    d.value = e.margin,
    c.value = e.header,
    g.value = e.footer,
    OrgChart.animate(t.element.querySelector("#boc-ppdf-btns"), {
        margin: [0, 0, 0, -250]
    }, {
        margin: [0, 0, 0, 0]
    }, 300, OrgChart.anim.outSin, (function() {
...
OrgChart.pdfPrevUI._handler = function(t, e, r) {
    ...
    for (var s = l.querySelector("svg"), h = t.element.querySelector("#boc-ppdf-content"), d = 0; d < a.length; d++) {
        ...
        a[d].html ? g.write(OrgChart._exportHtml(a[d].html, e.styles, i, a[d].innerSize.w, a[d].innerSize.h, p, u, t.config.mode)) : (s.setAttribute("viewBox", a[d].vb),
        g.write(OrgChart._exportHtml(l.innerHTML, e.styles, i, a[d].innerSize.w, a[d].innerSize.h, p, u, t.config.mode)));
...
OrgChart._exportHtml = function(t, e, r, i, a, n, o, l) {
    ...
    return n && (d += '<div id="boc-header" style="width:' + i + "px;color:#757575;position:absolute;left:" + r.margin[3] + 'px;top:0;">' + n + "</div>"),
    d += t,
...
OrgChart.events.on("drag", (function(t, e, r, i) {
    if (t instanceof OrgChart && t.config.movable && i)
        for (var a = 0; a < i.length; a++) {
            for (var n = i[a], o = t.element.querySelectorAll(`[data-c-l-from="${n}"]`), l = t.element.querySelectorAll(`[data-c-l-to="${n}"]`), s = 0; s < o.length; s++)
...
OrgChart.prototype._clink = function(t, e) {
    for (var r = "", i = 0; i < this.config.clinks.length; i++) {
        ...
        if (n && -1 != e.res.visibleNodeIds.indexOf(n.id) && (o && -1 != e.res.visibleNodeIds.indexOf(o.id))) {
            ...
            r += ("<g " + OrgChart.attr.c_link_from + '="{from}" ' + OrgChart.attr.c_link_to + '="{to}">').replace("{from}", n.id).replace("{to}", o.id) + v.link.replaceAll("{d}", x) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + x + '" />',
...
OrgChart.prototype.removeClink = function(t, e) {
    ...
    return OrgChart.events.publish("updated", [this]),
    this
}
,
...
OrgChart.events.on("drag", (function(t, e, r, i) {
    if (t instanceof OrgChart && t.config.movable && i)
        for (var a = 0; a < i.length; a++) {
            for (var n = i[a], o = t.element.querySelectorAll(`[data-s-l-from="${n}"]`), l = t.element.querySelectorAll(`[data-s-l-to="${n}"]`), s = 0; s < o.length; s++)
                o[s].parentNode.removeChild(o[s]);
            for (s = 0; s < l.length; s++)
                l[s].parentNode.removeChild(l[s])
        }
...
OrgChart.prototype._slinks = function(t, e) {
    ...
    function n(e, n, o) {
        ...
        if (e.sl == n.sl)
            ...
            for (; null == h; ) {
                var O = !1
                  ...
                  , v = b.leftNeighbor
                  , y = b.rightNeighbor;
                if (b.id == n.id ? h = b : OrgChart._intersects(b, f, g) && (f = OrgChart._addPoint(b, s, g, f, d),
                O = !0),
                b.id != n.id) {
                    for (; v; ) {
                        if (v.id == n.id) {
                        ...
                        OrgChart._intersects(v, f, g) && (f = OrgChart._addPoint(v, s, g, f, d),
                        O = !0),
                        v = v.leftNeighbor
                    }
                    for (; y; ) {
                        ...
                        OrgChart._intersects(y, f, g) && (f = OrgChart._addPoint(y, s, g, f, d),
                        O = !0),
                        y = y.rightNeighbor
                    }
                }
        ...
        for (var E = 1; E < s.length; E++)
            s[E].unshift("L");
        var N = OrgChart.roundPathCorners(s, OrgChart.LINK_ROUNDED_CORNERS, !1);
        if (l.label) {
        ...
        o && (U = n.id,
        R = e.id),
        r += ("<g " + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace("{from}", U).replace("{to}", R) + p.link.replaceAll("{d}", N) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + N + '" />',
        r += OrgChart.grCloseTag
    }
...
OrgChart.events.on("renderbuttons", (function(t, e) {
    if (e.node && e.node.tags && e.node.tags.has("group-dotted-lines")) {
        var r = t.getScale()
          ...
          , a = "";
        e.node.min ? (i.nodeGroupDottedOpenButton || console.error(`[${e.node.templateName}].nodeGroupDottedOpenButton is not defined`),
        a += `<g style="cursor:pointer;"  data-ctrl-n-dotted-open="${e.node.id}" transform="matrix(1,0,0,1,${e.node.x},${e.node.y})">`,
        a += i.nodeGroupDottedOpenButton) : (i.nodeGroupDottedCloseButton || console.error(`[${e.node.templateName}].nodeGroupDottedCloseButton is not defined`),
        ...
        a = (a += "</g>").replaceAll("{cw}", e.node.w / 2).replaceAll("{ch}", e.node.h / 2).replaceAll("{ew}", e.node.w - (e.node.padding ? e.node.padding[1] : 0)).replaceAll("{eh}", e.node.h - (e.node.padding ? e.node.padding[2] : 0));
...
OrgChart.prototype.clearRedo = function() {
    if (this.config.undoRedoStorageName) {
        for (var t = `${this.config.undoRedoStorageName}_redo_`, e = Object.keys(sessionStorage), r = 0; -1 != e.indexOf(t + r); )
...
OrgChart.prototype.clearUndo = function() {
    if (this.config.undoRedoStorageName) {
        for (var t = `${this.config.undoRedoStorageName}_undo_`, e = Object.keys(sessionStorage), r = 0; -1 != e.indexOf(t + r); )
            sessionStorage.removeItem(t + r),
            r++;
        this.undoRedoUI.refresh()
    }
...
OrgChart.undoRedoUI.prototype.init = function(t) {
    t.config.undoRedoStorageName && (this.instance = t,
    this.refresh())
}
,
OrgChart.undoRedoUI.prototype.refresh = function() {
    ...
    if (this.instance.config.undoRedoStorageName) {
        ...
        if (!1 !== OrgChart.events.publish("change", [this, e])) {
            ...
            e.undoStepsCount > 0 ? (r.classList.add("boc-ur-clickable"),
            r.querySelector(".boc-undo-i").innerHTML = e.undoStepsCount,
            r.querySelector(".boc-undo-i").style.display = "inline-block") : (r.classList.remove("boc-ur-clickable"),
            r.querySelector(".boc-undo-i").style.display = "none"),
            e.redoStepsCount > 0 ? (i.classList.add("boc-ur-clickable"),
            i.querySelector(".boc-redo-i").innerHTML = e.redoStepsCount,
            i.querySelector(".boc-redo-i").style.display = "inline-block") : (i.classList.remove("boc-ur-clickable"),
            ...
            l.onmousemove = function(e) {
                if (s) {
                    ...
                    var d = l.getBoundingClientRect()
                      , c = d.left
                      , g = d.top;
                    n = parseInt(e.clientX - c),
                    o = parseInt(e.clientY - g);
            ...
            l.onclick = function(e) {
                ...
                OrgChart.miniMap._mouseMove)
                    ...
                    var i = l.getBoundingClientRect()
                      , a = i.left
                      , s = i.top;
                    n = parseInt(e.clientX - a),
                    o = parseInt(e.clientY - s);
                    var d = n / OrgChart.miniMap._settings._scale
                      , c = o / OrgChart.miniMap._settings._scale;
                    r[0] = d - (r[0] + r[2] - r[0]) / 2 - OrgChart.miniMap._settings._translateX / OrgChart.miniMap._settings._scale,
                    r[1] = c - (r[1] + r[3] - r[1]) / 2 - OrgChart.miniMap._settings._translateY / OrgChart.miniMap._settings._scale,
                    t.setViewBox(r),
                    h && (clearTimeout(h),
                    h = null),
                    h = setTimeout((function() {
    ...
    !function t(e, n) {
        if (Array.isArray(n))
            ...
            for (o = 0; o < n.stChildrenIds.length; o++)
                i++,
                a.includes(n.id) || (1 == i ? r.fillStyle = OrgChart.miniMap.colors[0] : 2 == i ? r.fillStyle = OrgChart.miniMap.colors[1] : 3 == i && (r.fillStyle = OrgChart.miniMap.colors[2]),
                r.beginPath(),
                r.fillRect(n.x, n.y, n.w, n.h),
                r.strokeRect(n.x, n.y, n.w, n.h),
                a.push(n.id)),
...
OrgChart.miniMap._drawRectSelectorCanvas = function(t, e) {
    ...
    var a = e[0]
      ...
      , o = e[2]
      , l = e[3];
    i.lineWidth = .5 / OrgChart.miniMap._settings._scale,
...
OrgChart.miniMap._initCtx = function(t, e, r) {
    ...
    i.globalAlpha = r,
    1 != r && (i.fillStyle = OrgChart.miniMap.selectorBackgroundColor,
...
OrgChart.miniMap._init = function(t) {
    if (!t.element.querySelector('[data-id="mini-map"]')) {
        ...
        r.style.left = 0;
        var i = document.createElement("div");
        i.setAttribute("data-id", "mini-map"),
        ...
        t._addEvent(i, "DOMMouseScroll", s),
        t._addEvent(i, "mousewheel", s);
        var h = 0
          , d = 0
          , c = function(t) {
            OrgChart.miniMap._mouseMove = !0;
...
OrgChart._search.searchAndComputeScore = function(t, e, r, i) {
    ...
    for (p = n.length - 1; p >= 0; p--)
        for (c = 0; c < n.length; c++)
            c < p && n[c].start + n[c].length > n[p].start && n.splice(p, 1);
    var b = e;
    for (p = n.length - 1; p >= 0; p--)
...
OrgChart.state._put = function(t, e, r, i, a, n, o, l) {
    if (l && !OrgChart.isNEU(a) && 0 != a.length) {
        ...
        l.writeToIndexedDB && (h.id = l.name,
...
OrgChart.events.on("init", (function(t, e) {
    if (t.config.keyNavigation && (t._addEvent(window, "keydown", t._windowKeyDownHandler),
...
OrgChart.events.on("click", (function(t, e) {
    t.config && t.config.keyNavigation && (t._keyNavigationActiveNodeId = e.node.id,
    t.center(e.node.id))
}
)),
OrgChart._keyNavigation = function(t) {
    ...
    if (!OrgChart.isNEU(t._keyNavigationActiveNodeId) && ((r = t.getNodeElement(t._keyNavigationActiveNodeId)) && r.children.length)) {
        ...
        !OrgChart.isNEU(n.text))
            ...
            i.appendChild(a);
        OrgChart.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE && t.searchUI.hide(),
        i.focus()
    }
}
,
...
OrgChart.input.validateAndGetData = function(t) {
    ...
    for (i = 0; i < n.length; i++) {
        ...
        if ("checkbox" == l.type.toLowerCase())
            o[s] = l.checked;
...
OrgChart.filterUI.prototype.addFilterTag = function(t) {
    ...
    if (OrgChart.isNEU(t))
        return !1;
    if (null !== this.filterBy || "object" != typeof this.instance.config.filterBy || Array.isArray(this.instance.config.filterBy) || (this.filterBy = JSON.parse(JSON.stringify(this.instance.config.filterBy))),
    null != this.filterBy)
...
OrgChart.filterUI.prototype.update = function() {
    if (this.instance.config.filterBy) {
        ...
        if ("all" == this.instance.config.filterBy)
            ...
            for (var a in this.instance.config.filterBy)
                t[a] = {};
        for (var n in t) {
            var o = t[n];
        ...
        this.instance.config.undoRedoStorageName ? (this.element.style.top = 0,
        this.element.style.left = "50%",
        this.element.style.transform = "translate(-50%)") : (this.element.style.top = this.instance.config.padding + "px",
        ...
        for (var s in this.filterBy) {
            ...
            OrgChart.events.publish("add-filter", [p, f]),
            u += f.html
        }
        this.element.innerHTML = `<div>${u}</div>`,
        this.element.addEventListener("click", (function(t) {
            if (t.target.hasAttribute("data-filter-close") || t.target.hasAttribute("data-filter-field")) {
                for (var e = t.target.getAttribute("data-filter-field"), r = p.instance.element.querySelectorAll("[data-filter-menu]"), i = 0; i < r.length; i++)
                ...
                t.target.hasAttribute("data-filter-close"))
                    return;
                if (!t.target.hasAttribute("data-filter-field"))
                    return;
                ...
                if (!o) {
                    ...
                    for (i = 0; i < u.length; i++)
                        u[i].addEventListener("change", (function(t) {
                            for (var e = t.target; e && !e.hasAttribute("data-filter-menu"); )
                                e = e.parentNode;
                            if (e) {
                                ...
                                if (t.target.hasAttribute("data-all")) {
                                    for (var i = t.target.parentNode.parentNode.querySelectorAll("input"), a = 0; a < i.length; a++)
                                        if (i[a] != t.target)
                                            ...
                                            p.filterBy[r])
                                                p.filterBy[r][n].checked = t.target.checked
                                } else if (null != p.filterBy[r][this.name] && (p.filterBy[r][this.name].checked = this.checked),
                                this.checked)
                                    for (var o = p.instance.config.nodes, l = 0; l < o.length; l++)
                                        if (o[l][r] == this.name)
                                            for (var s = o[l]; s; )
                                                if (OrgChart.isNEU(s.stpid))
                                                    s = OrgChart.isNEU(s.pid) ? null : p.instance._get(s.pid);
                                                else if ((s = p.instance._get(s.stpid))[r]) {
                                                    var h = t.target.parentNode.parentNode.querySelector('[name="' + s[r] + '"]');
                                                    h ? (h.checked = this.checked,
                                                    p.filterBy[r][s[r]].checked = this.checked) : console.error('Cannot find element with selector: [name="' + s[r] + '"]')
                                                }
                                p.instance.draw()
                            }
                        }
                ...
                OrgChart.events.publish("show-items", [p, {
                    name: e
                }])
            }
        }
...
OrgChart.remote._setPositions = function(t, e, r, i) {
    for (var a = [], n = [], o = OrgChart.remote._toReqLayoutConfigsDTO(e), l = 0; l < t.length; l++)
        n.push(t[l].id),
    ...
    null != OrgChart.remote._fromReqDTO)
        ...
        h && (h = JSON.parse(h)),
        h && !h.limit ? OrgChart.remote._proceed(t, h, i, r) : OrgChart.remote._findRegion((function(e) {
            OrgChart._ajax(e, "post", s, "json", (function(e) {
                e.error ? r(2) : (OrgChart.remote._proceed(t, e, i, r),
...
OrgChart.remote._findRegion = function(t) {
    ...
    if (e)
        ...
        for (var r = ["defunc2", "cusfunc2", "bsfunc2", "acfunc2", "kcfunc2", "safunc2", "wifunc2"], i = [], a = 0; a < r.length; a++)
            ...
            !function() {
                ...
                n.onreadystatechange = function() {
                    if (4 == this.readyState && 200 == this.status) {
                        OrgChart.localStorage.setItem(OrgChart.FUNC_URL_NAME, e),
                        t(e);
