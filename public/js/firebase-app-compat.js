...
((e, t) => {
    ...
    let F = () => {},
        ...
        n = {
            ...
            decodeString(r, n) {
                ...
                {
                    var a = this.decodeStringToByteArray(r, n);
                    var i = [];
                    let e = 0,
                        t = 0;
                    for (; e < a.length; ) {
                        var s,
                            ...
                            c = a[e++];
                        c < 128
                            ? (i[t++] = String.fromCharCode(c))
                            : 191 < c && c < 224
                                ? ((s = a[e++]),
                                    (i[t++] = String.fromCharCode(((31 & c) << 6) | (63 & s))))
                                : 239 < c && c < 365
                                    ? ((s =
                                        (((7 & c) << 18) |
                                            ((63 & a[e++]) << 12) |
                                            ...
                                            (63 & a[e++])) -
                                        65536),
                                        (i[t++] = String.fromCharCode(55296 + (s >> 10))),
                                        (i[t++] = String.fromCharCode(56320 + (1023 & s))))
                                    : ((o = a[e++]),
                                        (l = a[e++]),
            ...
            decodeStringToByteArray(e, t) {
                ...
                for (let l = 0; l < e.length; ) {
                    var a = r[e.charAt(l++)],
                        i = l < e.length ? r[e.charAt(l)] : 0,
                        s = ++l < e.length ? r[e.charAt(l)] : 64,
                        o = ++l < e.length ? r[e.charAt(l)] : 64;
                    if ((++l, null == a || null == i || null == s || null == o))
                        throw new M();
                    n.push((a << 2) | (i >> 4)),
                    64 !== s &&
                    (n.push(((i << 4) & 240) | (s >> 2)), 64 !== o) &&
                    n.push(((s << 6) & 192) | o);
                }
                return n;
            },
    ...
    function l(e, t) {
        ...
        for (var r in t)
            t.hasOwnProperty(r) && "__proto__" !== r && (e[r] = l(e[r], t[r]));
        return e;
    }
    function x() {
    ...
    let H = () => x().__FIREBASE_DEFAULTS__,
        ...
        U = () => {
            var e;
            return null == (e = W()) ? void 0 : e.config;
        };
    class J {
        constructor() {
            (this.reject = () => {}),
    ...
    function c(e, t) {
        if (e !== t) {
            ...
            for (n of i) if (!a.includes(n)) return;
        }
        return 1;
    }
    function X(e) {
        ...
        subscribe(e, t, r) {
            ...
            (n = ((e, t) => {
                if ("object" == typeof e && null !== e)
                    for (var r of t) if (r in e && "function" == typeof e[r]) return 1;
    ...
    class Q {
        ...
        onInit(e, t) {
            ...
            let n = null != (a = this.onInitCallbacks.get(r)) ? a : new Set();
    ...
    class ee {
        ...
        getProvider(e) {
            ...
            return this.providers.has(e)
                ...
                : ((t = new Q(e, this)), this.providers.set(e, t), t);
        }
        getProviders() {
    ...
    class ie {
        ...
        setLogLevel(e) {
            this._logLevel = "string" == typeof e ? te[e] : e;
        }
        get logHandler() {
    ...
    let se = (t, e) => e.some((e) => t instanceof e),
        oe,
        le;
    let ce = new WeakMap(),
        g = new WeakMap(),
    ...
    function de(n) {
        ...
        "objectStoreNames" in IDBTransaction.prototype
            ? (le = le || [
                ...
                ? function (...e) {
                    return n.apply(y(this), e), _(ce.get(this));
                }
                : function (...e) {
                    return _(n.apply(y(this), e));
                }
            : function (e, ...t) {
                var r = n.call(y(this), e, ...t);
                return he.set(r, e.sort ? e.sort() : [e]), _(r);
            };
    }
    function pe(e) {
        var i, t;
        ...
        return e instanceof IDBRequest
            ? ((i = e),
                (t = new Promise((e, t) => {
                    ...
                    .then((e) => {
                        e instanceof IDBCursor && ce.set(e, i);
                    })
                    .catch(() => {}),
                v.set(t, i),
                t)
            : b.has(e)
                ? b.get(e)
                : ((t = pe(e)) !== e && (b.set(e, t), v.set(t, e)), t);
    }
    let y = (e) => v.get(e);
    let ue = ["get", "getKey", "getAll", "getAllKeys", "count"],
    ...
    function ge(e, t) {
        if (e instanceof IDBDatabase && !(t in e) && "string" == typeof t) {
            ...
            let a = t.replace(/FromIndex$/, ""),
                ...
                s = fe.includes(a);
            var r;
            return a in (i ? IDBIndex : IDBObjectStore).prototype &&
            (s || ue.includes(a))
    ...
    m = {
        ...(f = m),
        get: (e, t, r) => ge(e, t) || f.get(e, t, r),
        has: (e, t) => !!ge(e, t) || f.has(e, t),
    };
    class be {
        constructor(e) {
            this.container = e;
    ...
    function L(e) {
        ...
        if (A.has(n))
            return (
                I.debug(`There were multiple attempts to register component ${n}.`), !1
            );
        A.set(n, e);
        for (t of S.values()) N(t, e);
        for (r of O.values()) N(r, e);
        return !0;
    }
    function _e(e, t) {
    ...
    class we extends Ee {
        constructor(e, t, r, n) {
            var a =
                    ...
                    t.automaticDataCollectionEnabled,
                i = { name: r, automaticDataCollectionEnabled: a };
            void 0 !== e.apiKey ? super(e, i, n) : super(e.options, i, n),
                (this._serverConfig = Object.assign(
                    { automaticDataCollectionEnabled: a },
                    t
                )),
            this._serverConfig.authIdToken &&
            Ce(this._serverConfig.authIdToken, "authIdToken"),
            this._serverConfig.appCheckToken &&
            Ce(this._serverConfig.appCheckToken, "appCheckToken"),
    ...
    function T(e, t = {}) {
        ...
        var n = Object.assign({ name: D, automaticDataCollectionEnabled: !1 }, t);
        let a = n.name;
        if ("string" != typeof a || !a)
            throw B.create("bad-app-name", { appName: String(a) });
        if (!(r = r || U())) throw B.create("no-options");
        var i = S.get(a);
        if (i) {
            if (c(r, i.options) && c(n, i.config)) return i;
            throw B.create("duplicate-app", { appName: a });
        }
        var s,
            o = new ee(a);
        for (s of A.values()) o.addComponent(s);
        i = new Ee(r, n, o);
        return S.set(a, i), i;
    }
    async function t(e) {
        ...
        S.has(r)
            ? ((t = !0), S.delete(r))
            : O.has(r) && e.decRefCount() <= 0 && (O.delete(r), (t = !0)),
        t &&
    ...
    function R(e, t, r) {
        ...
        var i,
            ...
            o = t.match(/\s|\//);
        s || o
            ? ((i = [`Unable to register library "${a}" with version "${t}":`]),
            s &&
            i.push(
            ...
            i.push(
                ...
                I.warn(i.join(" ")))
            : L(new h(a + "-version", () => ({ library: a, version: t }), "VERSION"));
    }
    function De(e, t) {
    ...
    let Oe = "firebase-heartbeat-database",
        Ae = 1,
        k = "firebase-heartbeat-store",
        Ne = null;
    function Le() {
        return (Ne =
            Ne ||
            ((e, t, { blocked: r, upgrade: n, blocking: a, terminated: i }) => {
                let s = indexedDB.open(e, t);
                var o = _(s);
                return (
                    n &&
                    s.addEventListener("upgradeneeded", (e) => {
                        n(_(s.result), e.oldVersion, e.newVersion, _(s.transaction), e);
                    }),
                    r &&
    ...
    async function Be(e, t) {
        try {
            var r = (await Le()).transaction(k, "readwrite");
            await r.objectStore(k).put(t, Te(e)), await r.done;
        } catch (e) {
            e instanceof s
                ? I.warn(e.message)
                : ((r = B.create("idb-set", {
    ...
    class Re {
        ...
        async triggerHeartbeat() {
            ...
            try {
                ...
                if (
                    ...
                    null != (null == (r = this._heartbeatsCache) ? void 0 : r.heartbeats))
                )
                    if (
                        ...
                        return (
                            this._heartbeatsCache.heartbeats.push({ date: t, agent: a }),
                            30 < this._heartbeatsCache.heartbeats.length &&
                            ((n = ((e) => {
                                ...
                                this._heartbeatsCache.heartbeats.splice(n, 1)),
        ...
        async getHeartbeatsHeader() {
            ...
            try {
                ...
                null == (null == (e = this._heartbeatsCache) ? void 0 : e.heartbeats) ||
                    ...
                    : ((t = ke()),
                        ({ heartbeatsToSend: r, unsentEntries: n } = ((e, t = 1024) => {
                            ...
                            for (let i of e) {
                                ...
                                if (a) {
                                    if ((a.dates.push(i.date), Fe(r) > t)) {
                                        a.dates.pop();
                                        break;
                                    }
                                } else if (
                                    (r.push({ agent: i.agent, dates: [i.date] }), Fe(r) > t)
                                ) {
                                    r.pop();
                                    break;
                                }
                        ...
                        (a = i(JSON.stringify({ version: 2, heartbeats: r }))),
                        (this._heartbeatsCache.lastSentHeartbeatDate = t),
                        0 < n.length
    ...
    class Pe {
                ...
                new Promise((n, a) => {
                    try {
                        let e = !0,
                            ...
                            r = self.indexedDB.open(t);
                        (r.onsuccess = () => {
                            r.result.close(), e || self.indexedDB.deleteDatabase(t), n(!0);
                        }),
                            (r.onupgradeneeded = () => {
                                e = !1;
                            }),
                            (r.onerror = () => {
                                var e;
                                a((null == (e = r.error) ? void 0 : e.message) || "");
                            });
                    } catch (e) {
                        a(e);
                    }
        ...
        async read() {
            ...
            (e = await (async (e) => {
                try {
                    var t = (await Le()).transaction(k),
                        r = await t.objectStore(k).get(Te(e));
    ...
    (e = ""),
        L(new h("platform-logger", (e) => new be(e), "PRIVATE")),
        L(new h("heartbeat", (e) => new Re(e), "PRIVATE")),
        R(C, w, e),
        R(C, w, "esm2017"),
        R("fire-js", "");
    var Me = Object.freeze({
        ...
        _removeServiceInstance: function (e, t, r = D) {
            _e(e, t).clearInstance(r);
        },
        _serverApps: O,
        deleteApp: t,
        getApp: function (e = D) {
        ...
        initializeServerApp: function (e, t) {
            ...
            var n =
                ...
                a = O.get(n);
            if (a) a.incRefCount(t.releaseOnDeref);
            else {
                var i,
                    s = new ee(n);
                for (i of A.values()) s.addComponent(i);
                (a = new we(r, t, n, s)), O.set(n, a);
            }
            return a;
        },
        onLog: De,
    ...
    class je {
        constructor(e, t) {
            (this._delegate = e),
                (this.firebase = t),
                N(e, new h("app-compat", () => this, "PUBLIC")),
        ...
        delete() {
            return new Promise((e) => {
                ...
                () => (this.firebase.INTERNAL.removeApp(this.name), t(this._delegate))
            );
        }
        _getService(e, t = D) {
            this._delegate.checkDestroyed();
            var r,
                n = this._delegate.container.getProvider(e);
            return (
                n.isInitialized() ||
                "EXPLICIT" !==
                (null == (r = n.getComponent()) ? void 0 : r.instantiationMode) ||
                n.initialize(),
                    n.getImmediate({ identifier: t })
            );
        }
        _removeServiceInstance(e, t = D) {
    ...
    let ze = new a("app-compat", "Firebase", {
        "no-app":
    ...
    function xe(a) {
                            ...
                            n = r.replace("-compat", "");
                        {
                            ...
                            ((e = (e = o()) => {
                                if ("function" != typeof e[n])
                                    throw ze.create("invalid-app-argument", { appName: r });
                                return e[n]();
                            }),
                            void 0 !== t.serviceProps && l(e, t.serviceProps),
                                (s[n] = e),
        ...
        function o(e) {
            if (((e = e || D), Y(i, e))) return i[e];
            throw ze.create("no-app", { appName: e });
        }
        return (
            (s.default = s),
    ...
    P = He;
    R("@firebase/app-compat", "0.2.52", void 0);
    return P.registerVersion("firebase", "11.5.0", "app-compat-cdn"), P;
});
