...
class Building extends Model
{
    ...
    public function pictures() { return $this->hasMany(BuildingPicture::class, 'building_id', 'id'); }

    public function levels() { return $this->hasMany(BuildingLevel::class, 'building_id', 'id'); }

    public function documents() { return $this->hasMany(BuildingDocument::class, 'building_id', 'id'); }
