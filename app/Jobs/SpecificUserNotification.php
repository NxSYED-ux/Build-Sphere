...
class SpecificUserNotification implements ShouldQueue
{
    ...
    public function __construct($userId, $image, $heading, $message, $link, $initiatorId = null, $initiatorHeading = null, $initiatorMessage = null, $initiatorLink = null)
    {
        $this->userId = $userId;
        $this->image = $image;
