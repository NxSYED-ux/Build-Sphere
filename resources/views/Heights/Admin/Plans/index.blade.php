...
<head>
    ...
    <title>Create Custom Plan | PropManager</title>
    <!-- Bootstrap 5.3.3 CSS -->
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand fw-bold" href="index.html">
            <i class="fas fa-building me-2"></i>PropManager
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item ms-lg-3">
                    <a class="btn btn-primary-custom btn-custom" href="#"><i class="fas fa-shopping-cart me-2"></i>Checkout</a>
                </li>
            </ul>
        </div>
    </div>
