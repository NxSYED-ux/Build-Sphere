                                ...
                                <form action="{{ route('roles.update') }}" method="POST">
                                    ...
                                    <div class="form-section">
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="updated_at" value="{{ $role->updated_at }}">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                                               value="{{ old('name', $role->name) }}" maxlength="50" placeholder="Role Name" required>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control" id="description" name="description" maxlength="250" placeholder="Description">{{ old('description', $role->description) }}</textarea>
                                                    @error('description')
                                    ...
                                    <div class="form-section mt-2">
                                        ...
                                        @isset($permissions)
                                            @php
                                                ...
                                                $oldPermissions = old('permissions', $rolePermissionIds);
                                            @endphp
                                                                ...
                                                                <div class="row">
                                                                    @foreach($permissionGroup->filter(fn($permission) => $permission->parent_id === null) as $permission)
                                                                        @php
                                                                            ...
                                                                            // Determine checked state - use old input if available, otherwise use role's permissions
