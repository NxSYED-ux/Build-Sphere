                    ...
                    <div class="col-md-12">
                        <div class="report-container">
                            ...
                            <p class="section-description">
                                ...
                                financial metrics showing income and expenses. The trend indicators help you
                                understand how these metrics are changing compared to the previous period.
                            </p>
                            ...
                            <p class="section-description">
                                ...
                                detailed numbers. The progress bars below indicate growth trends, helping you track whether your
                                income is growing faster than expenses - a key indicator of sustainable operations.
                            </p>
                            ...
                            <p class="section-description">
                                These breakdowns show where your money is coming from and where it's being spent.
                                The income sources chart helps identify which revenue streams are most profitable,
                                while the expense categories chart highlights your biggest cost centers.
                                Understanding these distributions can help you make informed decisions about
                                where to focus your revenue generation efforts and where to look for cost savings.
                            </p>
                            ...
                            <p class="section-description">
                                The unit occupancy section provides a comprehensive view of how your property space is being utilized.
                                The time-series chart shows occupancy trends over the selected period, helping you identify seasonal
                                patterns or changes in demand. The status cards below give you current counts of rented, sold, and
                                available units, with the overall occupancy rate indicating how effectively you're utilizing your
                                property assets.
                            </p>
                            ...
                            <p class="section-description">
                                Your staff are critical to maintaining property operations and tenant satisfaction.
                                This section shows how your workforce is distributed across different departments,
                                helping you understand resource allocation. The staff satisfaction and turnover rate
                                metrics provide insights into your human resources health - high satisfaction and low
                                turnover typically correlate with better service quality and lower recruitment costs.
                            </p>
                            ...
                            <p class="section-description">
                                Membership metrics track participation in your property's amenities and services.
                                The line chart shows trends in active vs. expired memberships over time, while
                                the summary provides key statistics about your membership base. The renewal rate
                                is particularly important as it indicates how well you're retaining members, which
                                is typically more cost-effective than acquiring new ones. The engagement rate shows
                                how actively members are using the services they've signed up for.
                            </p>
                            ...
                            <p class="section-description">
                                Maintenance requests are a key indicator of your property's condition and tenant satisfaction.
                                This chart tracks the volume of requests over time, helping you identify spikes that might
                                indicate systemic issues. The status distribution shows your team's responsiveness - a high
                                completion rate suggests efficient operations, while many pending requests might indicate
                                resource constraints. Rejected requests should be monitored as they may represent
                                tenant dissatisfaction if not properly justified.
                            </p>
                            ...
                            <p class="section-description">
                                The transactions table provides a detailed record of all financial activities.
                                You can see individual payments from tenants, expenses for maintenance and services,
                                and other financial transactions. Each entry includes status information to help you
                                track pending or completed transactions. The table is paginated for easy navigation
                                through large datasets, and you can view details or download receipts/invoices for
                                individual transactions as needed for record-keeping or dispute resolution.
                            </p>
                        </div>
                    </div>
                </div>
