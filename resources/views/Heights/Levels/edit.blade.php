        ...
        <section class="content-header pt-2">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mx-5">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="">Edit Level</a></li>
                </ol>
            </nav>
        </section>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select class="form-select" id="building_id" name="building_id" required>
                                                            ...
                                                            @foreach($buildings as $building)
                                                                <option value="{{ $building->id }}" {{ old('building_id', $level->building_id) == $building->id ? 'selected' : '' }}>
                                                                    {{ $building->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="status" id="status" class="form-select" required> 
                                                            ...
                                                            <option value="Rejected" {{ old('status', $level->status) == 'Rejected' ? 'selected' : '' }}>Rejected</option>  
                                                        </select>
                                                        @error('status')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
