...
@push('styles')
    <style>
        ...
        .image-upload-icon {
            ...
            position: absolute;
            bottom: 5px; /* Move the icon above the image */
            right: 0px; /* Move the icon to the right outside the image */
                        ...
                        <div class="box ">
                            <div class="container py-4"> 
                                ...
                                <div class="profile-card">
                                    ...
                                    <form method="POST" action="{{ route('users.profile.update', $user->id) }}" id="profile-form"> 
                                        @method('PUT')
                                        <div class="row"> 
