                ...
                <div class="login-content">
                    <form method="POST" action="{{ route('password.email') }}" class="m-2">
                        ...
                        <div class="input-div one">
                            ...
                            <div class="div">
                                <h5>Email</h5>
                                <input id="email" class="input block mt-1 w-full" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="email" />
                            </div>
                        </div>
                        @error('email')
        ...
        @if (session('success') || session('error') || $errors->any())
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    icon = 'success';
                    iconColor = getComputedStyle(document.documentElement).getPropertyValue('#28a745').trim();
                    @elseif (session('error'))
                        title = 'Error!';
                    text = '{{ session('error') }}';
                    icon = 'error';
                    iconColor = getComputedStyle(document.documentElement).getPropertyValue('#ff5b61').trim();
                    @endif
                    ...
                    Swal.fire({
                        ...
                        background: getComputedStyle(document.documentElement).getPropertyValue('#fff').trim(),
                        color: getComputedStyle(document.documentElement).getPropertyValue('#000000').trim(),
                        iconColor: iconColor,
                        customClass: {
