    ...
    <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">
        ...
        <div class="scrollable-content pt-4">
            <ul class=" ps-0 ">
                ...
                <li class="mb-1">
                    <div id="link-a">
                        <a href="{{url('owner_manager_dashboard')}}" class="link-dark collapsed {{ in_array('Dashboard', $openSections) ? 'Link-background-color' : '' }} px-1" id="AdminDashboardbtn" >
                ...
                <li class="mb-1">
                    ...
                    <div class="collapse {{ in_array('Buildings', $openSections) ? 'show' : '' }}" id="Buildings" style="">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li><a href="{{ route('owner_buildings.index') }}" class="link-dark {{ in_array('Building', $openSections) ? 'Link-background-color' : '' }}" data-bs-target="#Buildings "><i class="bx bx-buildings icons"></i> Buildings</a></li>
                            <li><a href="" class="link-dark {{ in_array('Levels', $openSections) ? 'Link-background-color' : '' }}" data-bs-target="#AdminControl" ><i class="bx bxs-city icons"></i> Levels</a></li>
